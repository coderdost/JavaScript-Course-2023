...
**3.5:** Create **higher** order function named as `transformer` which take `string` and `firstUpperCaseWord` function as an arguments. And return `string` with first word in **upperCase**
...
**4.2:** Create an object called 'Country' for a country of your choice, containing properties 'country', 'capital', 'language', 'population' and 'neighbors'
...
**4.4:** Create a method **describeCar** inside _car_ object in which you have to print like this in console using template literals
...
**Question 5:** What is difference between ** proto ** and prototype property of Object? Explain with **Example**?
